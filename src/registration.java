...
public class registration extends javax.swing.JFrame {
    ...
    public registration(DataInputStream input, DataOutputStream output) {
    	in = input; 
    	out = output;
        initComponents();
    }
			...
			public void actionPerformed(ActionEvent e) {
            	...
            	String userName = jTextField5.getText();
                 ...
                 try {
                	 ...
                	 JOptionPane.showMessageDialog(jButton1, " Registration succesfull ");
                   //  setVisible(false); 
                     new Login(in,out).setVisible(true);
...
//                     connection.close();
        ...
        Login1.setBackground(new java.awt.Color(0, 102, 255));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registration(in, out).setVisible(true);
            }
        });
    }
